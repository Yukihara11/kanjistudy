...
var KanjivgAnimate = function () {
    function t(t, e) {
        e = "undefined" != typeof e ? e : 500, this.setOnClick(t, e)
    }

    return t.prototype.setOnClick = function (t, e) {
        for (var i = document.querySelectorAll(t), n = i.length, s = 0; n > s; s++) i[s].onclick = function () {
            var t = new KVGAnimator(e);
            return t.play(this), !1
        }
    }, t
    ...
    return t.prototype.play = function (t) {
        ...
        if (e && "svg" === e.tagName && !(e.querySelectorAll("path") <= 0)) {
            ...
            var i = this.paths[this.count], n = this.numbers[this.count];
            this.animatePath(i, n)
        }
        ...
        for (var t = 0; t < this.pathCount; t++) this.paths[t].style.display = "none", "undefined" != typeof this.numbers[t] && (this.numbers[t].style.display = "none")
    }, t.prototype.animatePath = function (t, e) {
        this.length = t.getTotalLength(), t.style.display = "block", "undefined" != typeof e && (e.style.display = "block"), t.style.transition = t.style.WebkitTransition = "none", t.style.strokeDasharray = this.length + " " + this.length, t.style.strokeDashoffset = this.length, t.getBoundingClientRect(), this.interval = this.time / this.length, this.doAnimation(t)
