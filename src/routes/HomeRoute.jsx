import Introduction from "../components/Homeroute/Introduction.jsx";
import Tutorial from "../components/Homeroute/Tutorial.jsx";

function HomeRoute() {
    return (
        <div>
            <Introduction/>
            <Tutorial source="https://placehold.co/400x400" title="Study"
            ...
            <Tutorial source="https://placehold.co/400x400" title="Test"
